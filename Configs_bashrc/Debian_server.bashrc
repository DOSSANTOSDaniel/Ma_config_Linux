...
echo
echo "+----------------------------+----------------------+------------------+----------------+"
echo "|         Alias              |     Fonctions        |    Scripts       |    CLI Apps    |"
echo "+----------------------------+----------------------+------------------+----------------+"
echo "|        rm                  | maj      - Upgrade   |alerts.sh         | git    ncdu    |"
echo "|        mv                  | logerr   - Logs      |incr_backup_win.sh| inxi   certbot |"
echo "|        cp                  | banner   - Banner    |iso_download.sh   | podman pstree  |"
echo "|                            | del_temp - del files |renew-ha-certs.sh | screen ufw     |"
echo "|                            |                      |                  | acme.sh        |"
echo "+----------------------------+----------------------+------------------+----------------+"
echo
pong